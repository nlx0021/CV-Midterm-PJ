...
def get_map(MINOVERLAP, draw_plot, path = './map_out'):
        ...
        for txt_file in dr_files_list:
            ...
            for line in lines:
                ...
                if last_class_name is None:
                    last_class_name = tmp_class_name
                else:
                    if last_class_name == tmp_class_name:
                        ct += 1
                    else:
                        ct = 0
                        last_class_name = tmp_class_name
    ...
    with open(RESULTS_FILES_PATH + "/results.txt", 'w') as results_file:
        ...
        for class_index, class_name in enumerate(gt_classes):
            ...
            ##### FIXME
            one_acc = rec[score05_idx]
            one_correct = one_acc * nd
            sum_correct += one_correct
            ##### FIXME
    ...
    mIOU_mod = sum_IOU / count_IOU_mod
    mIOU = sum_IOU / count_IOU
    acc = sum_correct / sum_nd
